...
export const metadata: Metadata = {
  ...
  description:
    "Danh sách các dòng máy ảnh Canon chuyên nghiệp. Hỗ trợ mua mới và thuê thiết bị theo ngày giá tốt nhất.",
};
  ...
  if (products.length === 0) {
    products = [
      ...
      },
      {
        ...
        description: "Ống kính zoom đa dụng",
        imageUrl:
    ...
    <div className="container mx-auto py-10 px-4 md:px-6">
      <div className="flex flex-col gap-4 mb-8">
        <h1 className="text-3xl font-bold tracking-tight text-foreground">
          Sản phẩm Thiết bị Canon
        </h1>
        <p className="text-muted-foreground">
          Khám phá các thiết bị chuyên nghiệp. Hệ sinh thái toàn diện dành cho
          bạn.
        </p>
      </div>
